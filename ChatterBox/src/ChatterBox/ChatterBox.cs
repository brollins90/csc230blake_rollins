namespace ChatterBox
{
    ...
    public class ChatterBox : IChatterBox
    {
        ...
        private void Preload()
        {
            ...
            //ProcessParseTree(ProcessString("A 96 mile road connects New York to Philidelphia"));
            ...
            //ProcessParseTree(ProcessString("A 2711 mile road connects Los Angeles to Philidelphia"));
            ...
            //ProcessParseTree(ProcessString("A 759 mile road connects Chicago to Philidelphia"));
            ...
            //ProcessParseTree(ProcessString("A 1545 mile road connects Houston to Philidelphia"));
            ...
            //ProcessParseTree(ProcessString("A 2342 mile road connects Philidelphia to Phoenix"));
            //ProcessParseTree(ProcessString("A 1742 mile road connects Philidelphia to San Antonio"));
            //ProcessParseTree(ProcessString("A 2696 mile road connects Philidelphia to San Diego"));
            //ProcessParseTree(ProcessString("A 1467 mile road connects Philidelphia to Dallas"));
            //ProcessParseTree(ProcessString("A 2909 mile road connects Philidelphia to San Jose"));
